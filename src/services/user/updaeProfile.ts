...
export const addAchievementsRequest = async (
  data: Achievement
...
export const deleteAchievementsRequest = async (
  id: number
): Promise<OKResponse> => {
  try {
...
export const addworkhistoryRequest = async (
  data: WorkHistoryInput
): Promise<WorkHistorySuccessResponse> => {
  try {
...
export const deleteworkhistoryRequest = async (
  id: number
): Promise<OKResponse> => {
  try {
...
export const addWorkHistoryRequest = async (
  ...
  try {
    ...
    const response = await axios.post<WorkHistorySuccessResponse>(
      "work-history",
      data
    );
 ...
 */
export const updateWorkHistoryRequest = async (
  id: number,
  data: WorkHistoryInput
): Promise<WorkHistorySuccessResponse> => {
  try {
    ...
    const response = await axios.put<WorkHistorySuccessResponse>(
      `work-history/${id}`,
      data
    );
    showSnackbar(response.data.message, "success");
